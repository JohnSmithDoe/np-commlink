...
export const CashActions = createActionGroup({
  ...
  events: {
    ...
    // The catalog's own view state, now that it is rendered by the shared list
    // page. Separate from any transaction-list state: a search typed on the
    // catalog page must not narrow the ledger.
