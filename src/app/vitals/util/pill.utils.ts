...
import { IsoWeekday, Marker } from '../../@shared/model/app.types';
...
export const WEEKDAY_LABEL: Readonly<Record<IsoWeekday, Marker>> = {
  1: marker('vitals.weekday.mon'),
  2: marker('vitals.weekday.tue'),
  3: marker('vitals.weekday.wed'),
  4: marker('vitals.weekday.thu'),
  5: marker('vitals.weekday.fri'),
  6: marker('vitals.weekday.sat'),
  7: marker('vitals.weekday.sun'),
};

export const WEEKDAY_FULL_LABEL: Readonly<Record<IsoWeekday, Marker>> = {
  1: marker('vitals.weekday-full.mon'),
  2: marker('vitals.weekday-full.tue'),
  3: marker('vitals.weekday-full.wed'),
  4: marker('vitals.weekday-full.thu'),
  5: marker('vitals.weekday-full.fri'),
  6: marker('vitals.weekday-full.sat'),
  7: marker('vitals.weekday-full.sun'),
};
