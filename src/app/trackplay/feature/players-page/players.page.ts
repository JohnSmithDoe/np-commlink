...
import { createOutline, peopleOutline, person } from 'ionicons/icons';
...
export class TrackplayPlayersPage {
  ...
  constructor() {
    addIcons({ createOutline, peopleOutline, person });
  }
  ...
  goToPlayer(id: TrackplayId): void {
    void this.#router.navigate(['/trackplay/games/player', id]);
  }
