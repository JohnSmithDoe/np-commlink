...
// Published dashboard-telemetry contract — the WRITE side, and the only part of the dashboard that belongs to @shared. Every program *reports* its summary here; it does not know or care who reads it.
//
