...
describe('recipes.selector', () => {
  // The lazy slices are registered by the route, but the telemetry reporter
  // subscribes as its effect registers — so every recipe selector has to survive
  // a slice that is not there yet.
