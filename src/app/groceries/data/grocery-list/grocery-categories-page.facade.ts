...
import { IAppState, TCategoryId, TItemListId } from '../../../@shared/types';
...
import { selectListCategories } from './grocery-list.selector';
...
// Active list id from the `:listId` route param. Module-scoped so the projector
// isn't re-created per facade instance.
